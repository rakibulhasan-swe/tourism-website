    ...
    <>
      ...
      <div className="container my-5">
        <Row>
          ...
          <p className="fs-6 fw-light text-center mb-5">
            We are commited to answering all your questions and meetings any
            need you may have. We should love to hear from you. Please fill out
            the form below so we may assist you.
          </p>

          <Col md={10} className="mx-auto">
            <form className="row g-3 mx-auto">
              <div className="col-md-6">
                <label forhtml="inputName4" className="form-label">
                  Name
                </label>
              ...
              <div className="col-12">
                <button
                  type="submit"
                  className="w-100 btn btn-dark text-white px-4"
                >
                  Submit
                </button>
              </div>
